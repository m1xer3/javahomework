...
public class TransformationString {
    ...
    private static void someString (String str){
        ...
        System.out.println("Строка содержит "+  find+" : " + str.contains(find));
        System.out.println("Позиция подстроки "+  find+" : " + str.indexOf(find));
        ...
        System.out.println("Вырезание строки "+  find+" : " + str.substring(0,str.indexOf(find))+str.substring(str.indexOf(find) + find.length(),str.length()));
    }
