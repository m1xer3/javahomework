...
Используем только маленькие буквы
    ...
    static String promptForRiddle (String hidenWord , String answer){
        ...
        //добиваем резульатат случайным количеством символов # что бы невозможно было отгадать слово по количеству символов
